...
CASTBAR_FAILED            = "Echec",
CASTBAR_INTERRUPTED       = "Interrompu",
CHARACTER_CLASS_LEVEL     = "%s |cffffffffde niveau %d|r",
...
MOVER_LABEL_BAG_BAR       = "Barre de sacs",
...
MOVER_LABEL_CRAFT_TRACKER = "Suivi d'artisanat",
...
CLASSIC_MODULES_PAGE         = "Modules Modern WoW",
CLASSIC_MODULES_INTRO        = "Importez n'importe quel module du theme Modern WoW dans votre theme Classic WoW.",
CLASSIC_MODULES_HINT         = "Rechargez l'interface pour appliquer les changements.",
CLASSIC_MODULES_RELOAD       = "Tapez /reload pour appliquer les changements des modules Modern WoW.",
CLASSIC_MODULE_UNIT_FRAMES   = "Cadres d'unite",
CLASSIC_MODULE_PARTY_FRAMES  = "Cadres du groupe",
CLASSIC_MODULE_ACTION_BARS   = "Barres d'action",
CLASSIC_MODULE_MINIMAP       = "Minicarte",
CLASSIC_MODULE_CHARACTER     = "Fenetre du personnage",
CLASSIC_MODULE_SPELLBOOK     = "Grimoire",
CLASSIC_MODULE_TALENTS       = "Fenetre des talents",
CLASSIC_MODULE_CRAFTING      = "Fenetre des metiers",
CLASSIC_MODULE_QUEST_LOG     = "Journal de quetes",
CLASSIC_MODULE_BAGS          = "Sacs et banque",
CLASSIC_MODULE_LOOT          = "Fenetre de butin",
...
SWING_BAR_WIDTH           = "Largeur de la barre",
SWING_BAR_HEIGHT          = "Hauteur de la barre",
SWING_BAR_MAIN            = "MD",
SWING_BAR_OFF             = "MG",
...
ABC_SHOW_GRYPHONS         = "Afficher les griffons",
ABC_CLASSIC_BAR_ACTION_ONLY = "Utiliser uniquement la barre d'action 1",
ABC_CLASSIC_BAR_ACTION_ONLY_HINT = "Desactive : conserve la barre 1 native complete (griffons, XP, micro-barre et sacs). Active : utilise la barre d'action 1 d'UnrealUI et restaure l'ancre Micro-barre separee apres /reload.",
ABC_CLASSIC_BAR_MODE_CHANGED = "Mode de la barre 1 modifie",
ABC_CLASSIC_BAR_MODE_RELOAD = "Tapez /reload pour appliquer le mode de la barre 1.",
...
-- Sous-pages du groupe Cadres d'unite dans la fenetre des options.
UF_TAB_GENERAL            = "Options generales",
UF_TAB_PARTY              = "Cadres de groupe",
UF_TAB_AURAS              = "Auras",
UF_TAB_COLORS             = "Couleurs",
UF_MENU_WHISPER           = "Chuchoter",
...
UF_MOVER_PORTRAIT_3D      = "Portrait 3D",

-- Modele 3D en direct dans l'anneau du portrait Modern WoW (modules/unitframes.lua
-- model3d) ; le fond circulaire en pierre reste dessous.
UF_PORTRAIT_HEADER        = "Portraits",
UF_PORTRAIT_3D_PLAYER     = "Portrait 3D du joueur",
UF_PORTRAIT_3D_TARGET     = "Portrait 3D de la cible",
UF_PORTRAIT_3D_TARGET_TARGET = "Portrait 3D de la cible de cible",
UF_PORTRAIT_3D_PARTY      = "Portraits 3D du groupe",
UF_PORTRAIT_3D_HINT       = "Themes Modern et Modern WoW. Chaque famille de cadres peut afficher son modele 3D independamment : dans un carre a cote du cadre avec Modern, sur le fond de portrait en pierre avec Modern WoW. Le portrait 2D est masque, sauf pour les membres du groupe trop eloignes.",
...
HOTS_HEADER               = "Indicateurs de soins periodiques",
HOTS_ENABLED              = "Afficher les soins periodiques",
HOTS_CORNER               = "Coin",
HOTS_SIZE                 = "Taille des icones",
HOTS_SPACING              = "Espacement des icones",
HOTS_CORNER_TOPLEFT       = "En haut a gauche",
HOTS_CORNER_TOPRIGHT      = "En haut a droite",
HOTS_CORNER_BOTTOMLEFT    = "En bas a gauche",
HOTS_CORNER_BOTTOMRIGHT   = "En bas a droite",
HEALPREDICT_HEADER        = "Soins entrants",
HEALPREDICT_ENABLED       = "Afficher les soins entrants sur les barres de vie",
HEALPREDICT_HINT          = "Colore la partie de la barre de vie que votre soin va remplir pendant son incantation, afin de voir un surplus de soins avant de le gaspiller. Ce client ne fournit aucune information sur les soins entrants : seuls vos propres sorts sont affiches, et un sort doit avoir ete observe une fois pour que son montant soit connu. Les soins des autres soigneurs n'apparaissent jamais.",
...
-- Bags and bank
-- ---------------------------------------------------------------------------
SETTINGS_BAGS_ENABLE      = "Activer",
SETTINGS_BAGS_ENABLE_HINT = "Remplace les fenetres de sacs du client par le sac unifie d'UnrealUI. Decocher arrete completement le sac UnrealUI et restaure les sacs par defaut du client, pour qu'un autre addon de sacs puisse prendre le relais sans conflit. Chaque changement necessite un rechargement.",
SETTINGS_BAGS_CHANGED     = "Interface des sacs modifiee",
SETTINGS_BAGS_RELOAD_ON   = "Tapez /reload pour utiliser le sac UnrealUI.",
SETTINGS_BAGS_RELOAD_OFF  = "Tapez /reload pour revenir aux sacs par defaut du client.",
SETTINGS_BAGS_CATEGORIES  = "Vue du sac par categorie",
SETTINGS_BAGS_CATEGORIES_HINT = "Regroupe le contenu du sac et de la banque dans des boites de categorie nommees au lieu d'une grille unique. Utilise les donnees de chaque objet, avec des groupes pour tissu, herbes, viande et minerai. Effet immediat, sans rechargement.",
-- Barre de sacs de l'ATH (modules/bagbar.lua) : les commandes de sac affichees
-- tant que le module de sac est desactive.
SETTINGS_BAGBAR_ENABLE      = "Afficher la barre de sacs a l'ecran",
SETTINGS_BAGBAR_ENABLE_HINT = "Place un bouton de sac a dos, les quatre emplacements de sacs equipes et le trousseau de cles dans le coin de l'ecran tant que le sac UnrealUI ci-dessus est desactive. Sans elle, aucune commande de sac ne reste a l'ecran, car les barres d'action UnrealUI remplacent la barre native sur laquelle le client place ses boutons de sac. Sans effet tant que le sac UnrealUI est actif, et un rechargement est requis dans les deux cas.",
SETTINGS_BAGBAR_RELOAD      = "Tapez /reload pour appliquer le changement de barre de sacs.",
BAGBAR_BACKPACK             = "Sacs",
BAGBAR_FREE_SLOTS           = "%d emplacements libres sur %d",
BAGBAR_OPEN_ALL_HINT        = "Le clic droit ouvre tous les sacs.",
BAGBAR_FREE_FORMAT          = "%d/%d",

ITEM_CATEGORY_FAVORITE    = "Favoris",
ITEM_CATEGORY_GEAR        = "Mon equipement",
ITEM_CATEGORY_QUEST       = "Objets de quete",
ITEM_CATEGORY_CONSUMABLE  = "Consommables",
ITEM_CATEGORY_FOOD        = "Nourriture et boisson",
ITEM_CATEGORY_POTION      = "Potions",
ITEM_CATEGORY_BUFF        = "Ameliorations",
ITEM_CATEGORY_BANDAGE     = "Bandages",
ITEM_CATEGORY_EXPLOSIVE   = "Explosifs",
ITEM_CATEGORY_REAGENT     = "Composants de classe",
ITEM_CATEGORY_LEATHER     = "Cuir",
ITEM_CATEGORY_CLOTH       = "Tissu",
ITEM_CATEGORY_HERB        = "Herbes",
ITEM_CATEGORY_ORE         = "Minerai et pierre",
ITEM_CATEGORY_GEM         = "Gemmes",
ITEM_CATEGORY_ENCHANTING  = "Composants d'enchantement",
ITEM_CATEGORY_ENGINEERING = "Pieces d'ingenierie",
ITEM_CATEGORY_MEAT        = "Viande",
ITEM_CATEGORY_TRADEGOODS  = "Artisanat",
ITEM_CATEGORY_RECIPE      = "Recettes",
ITEM_CATEGORY_AMMO        = "Munitions",
ITEM_CATEGORY_CONTAINER   = "Contenants",
ITEM_CATEGORY_KEY         = "Cles",
ITEM_CATEGORY_JUNK        = "Camelote",
ITEM_CATEGORY_MISC        = "Divers",
ITEM_CATEGORY_UNKNOWN     = "Non classe",

BAGS_TITLE                = "Sacs",
LOOT_TITLE                = "Objets",
LOOT_QUALITY_0            = "Mediocre",
LOOT_QUALITY_1            = "Commun",
LOOT_QUALITY_2            = "Inhabituel",
LOOT_QUALITY_3            = "Rare",
LOOT_QUALITY_4            = "Epique",
LOOT_QUALITY_5            = "Legendaire",
LOOT_QUALITY_6            = "Artefact",
BAGS_SLOT_COUNT           = "%d/%d",
BAGS_CATEGORY_EMPTY       = "Vide",
BAGS_SORT                 = "Trier les sacs",
BAGS_SORT_HINT            = "Reorganise vos sacs par categorie. Les sacs speciaux (herbes, ames, enchantement, ingenierie, carquois) ne sont pas touches.",
BAGS_SORT_BUSY            = "Tri deja en cours.",
BAGS_SORT_CURSOR          = "Reposez d'abord l'objet tenu par le curseur.",
...
BAGS_INVENTORY_FULL       = "Aucun emplacement de sac vide compatible n'est disponible.",
ITEMS_BUSY                = "Attendez la fin du tri ou de la fusion en cours.",
BAGS_STACK                = "Fusionner les piles",
BAGS_STACK_HINT           = "Fusionne les piles incompletes d'un meme objet dans vos sacs. Les objets de la banque ne sont pas touches.",
BAGS_BANK_VIEW            = "Voir la banque enregistree",
BAGS_BANK_VIEW_HINT       = "Affiche votre banque telle qu'elle etait lors de votre derniere visite chez un banquier. Lecture seule.",
BAGS_STACK_CURSOR         = "Reposez d'abord l'objet tenu par le curseur.",
BAGS_STACK_DONE           = "Piles des sacs fusionnees.",
BAGS_STACK_NOTHING        = "Aucune pile a fusionner dans les sacs.",
BAGS_STACK_FAILED         = "Fusion interrompue : un objet n'a pas bouge. Rien n'a ete perdu.",
BAGS_SEARCH               = "Rechercher",
...
BAGS_FAVORITE_HINT_ADD    = "Alt + Clic gauche : marquer comme favori",
BAGS_FAVORITE_HINT_REMOVE = "Alt + Clic gauche : retirer des favoris",
BAGS_FAVORITE_SELL_CONFIRM = "Vendre cet objet favori ?",
BAGS_FAVORITE_SELL_ACCEPT = "Vendre",
BAGS_FAVORITE_BATCH_SELL_ONE   = "%d objet gris est marque comme favori.",
BAGS_FAVORITE_BATCH_SELL_OTHER = "%d objets gris sont marques comme favoris.",
BAGS_FAVORITE_BATCH_DELETE_ONE   = "%d objet gris est marque comme favori.",
BAGS_FAVORITE_BATCH_DELETE_OTHER = "%d objets gris sont marques comme favoris.",
BAGS_FAVORITE_BATCH_DETAIL = "Les inclure, ou les ignorer et les garder dans vos sacs ?",
BAGS_FAVORITE_BATCH_INCLUDE = "Inclure",
BAGS_FAVORITE_BATCH_SKIP  = "Ignorer",
BAGS_FAVORITE_BATCH_NONE_LEFT = "Seuls des objets gris favoris ont ete trouves ; rien n'a ete fait.",
BANK_FULL                 = "Aucun emplacement de banque vide compatible n'est disponible.",
BANK_TITLE                = "Banque",
BANK_SORT                 = "Trier la banque",
BANK_SORT_HINT            = "Reorganise votre banque et ses sacs par categorie. Les sacs speciaux ne sont pas touches.",
BANK_SORT_BUSY            = "Tri deja en cours.",
BANK_SORT_CURSOR          = "Reposez d'abord l'objet tenu par le curseur.",
...
BANK_STACK                = "Fusionner les piles de la banque",
BANK_STACK_HINT           = "Fusionne les piles incompletes d'un meme objet dans votre banque et ses sacs. Les objets restent en banque. Les piles de la banque principale ont besoin d'un emplacement libre dans un sac de banque.",
BANK_STACK_CURSOR         = "Reposez d'abord l'objet tenu par le curseur.",
BANK_STACK_DONE           = "Piles de la banque fusionnees.",
BANK_STACK_NOTHING        = "Aucune pile a fusionner dans la banque.",
BANK_STACK_FAILED         = "Fusion de la banque interrompue : un objet n'a pas bouge. Rien n'a ete perdu.",
BANK_STACK_NOSTAGE        = "Certaines piles de la banque principale ont besoin d'un emplacement libre dans un sac de banque. Liberez-en un et reessayez.",
...
BANK_VIEW_TITLE           = "Banque enregistree",
BANK_VIEW_READONLY        = "Lecture seule",
BANK_VIEW_EMPTY           = "Aucune banque enregistree. Rendez-vous une premiere fois chez un banquier pour l'enregistrer.",
...
SPELLBOOK_TAB             = "Grimoire",
SPELLBOOK_PROFESSIONS     = "Metiers",
SPELLBOOK_PROF_FIRST      = "Premier metier",
SPELLBOOK_PROF_SECOND     = "Second metier",
SPELLBOOK_PROF_MISSING    = "Voyez un maitre pour apprendre un metier.",
SPELLBOOK_PROF_NOT_LEARNED = "Non appris",
SPELLBOOK_PROF_FISHING    = "Peche",
SPELLBOOK_PROF_COOKING    = "Cuisine",
SPELLBOOK_PROF_FIRST_AID  = "Secourisme",
SPELLBOOK_PROF_RANK_1     = "Apprenti",
SPELLBOOK_PROF_RANK_2     = "Compagnon",
SPELLBOOK_PROF_RANK_3     = "Expert",
SPELLBOOK_PROF_RANK_4     = "Artisan",
SPELLBOOK_PROF_UNLEARN    = "Desapprendre",
SPELLBOOK_PROF_UNLEARN_CONFIRM = "Desapprendre %s ?",
SPELLBOOK_PROF_UNLEARN_DETAIL = "Toute la competence et les recettes connues seront perdues.",
TALENTS_TITLE             = "Talents principaux - Actifs",
TALENTS_UNSPENT_POINTS    = "Points de talent disponibles : |cffffd100%d|r",
TALENTS_NEXT_LEVEL        = "Prochain talent disponible au |cffffd100niveau %d|r",
TALENTS_ROLE_DAMAGER     = "Degats",
TALENTS_ROLE_TANK        = "Tank",
TALENTS_ROLE_HEALER      = "Soins",
TA_TITLE                 = "Conseiller de talents",
TA_CONTEXT_LEVELING      = "Progression",
TA_CONTEXT_PVP           = "JcJ",
TA_CONTEXT_RAID          = "Raid",
TA_ROLE_DPS              = "Degats",
TA_ROLE_TANK             = "Tank",
TA_ROLE_HEALER           = "Soins",
TA_ROLE_HYBRID           = "Hybride",
TA_LEGEND                = "|cffffd119Or|r : maintenant / |cffffffffBlanc|r : apres / |cffff3838Rouge|r : hors config.",
TA_STATUS_NEXT           = "Prochain : %s (%d/%d)",
TA_STATUS_COMPLETE       = "Cette configuration est terminee.",
TA_STATUS_EARN_POINT     = "Niveau %d : %d points restent. Gagnez un point de talent.",
TA_STATUS_RESPEC         = "Aucun talent recommande ne peut etre appris.",
TA_STATUS_OUTSIDE        = "%d point(s) sont hors de cette configuration ; une reinitialisation peut etre necessaire.",
TA_STATUS_UNAVAILABLE    = "Cette configuration ne correspond pas aux donnees du client.",
TA_BUILD_ARMS            = "Armes a deux mains",
TA_BUILD_FURY            = "Fureur ambidextre",
TA_BUILD_PROTECTION      = "Protection profonde",
TA_BUILD_FERAL           = "Farouche",
TA_BUILD_HOTW_NS         = "Coeur du fauve / Rapidite de la nature",
TA_BUILD_BALANCE_NS      = "Equilibre / Rapidite de la nature",
TA_BUILD_MOONGLOW        = "Lueur de la lune",
TA_BUILD_RESTORATION     = "Restauration profonde",
TA_BUILD_BEAST_MASTERY   = "Maitrise des betes",
TA_BUILD_MARKSMAN        = "Precision",
TA_BUILD_MARKSMAN_SURVIVAL = "Precision / Survie",
TA_BUILD_FROST           = "Givre",
TA_BUILD_POM_FIRE        = "Presence spirituelle / Feu",
TA_BUILD_AP_FROST        = "Pouvoir des arcanes / Givre",
TA_BUILD_WINTERS_CHILL   = "Froid hivernal",
TA_BUILD_FIRE            = "Feu / Combustion",
TA_BUILD_RETRIBUTION     = "Vindicte",
TA_BUILD_HOLY_PVP        = "Sacre JcJ",
TA_BUILD_HOLY            = "Sacre",
TA_BUILD_HOLY_RETRIBUTION = "Sacre / Vindicte",
TA_BUILD_SHADOW_LEVELING = "Ombre - progression",
TA_BUILD_SHADOW          = "Ombre",
TA_BUILD_DISCIPLINE      = "Discipline profonde",
TA_BUILD_COMBAT_SWORDS   = "Combat aux epees",
TA_BUILD_HEMORRHAGE      = "Sang froid / Preparation / Hemorragie",
TA_BUILD_COMBAT_DAGGERS  = "Combat aux dagues",
TA_BUILD_ENHANCEMENT     = "Amelioration",
TA_BUILD_ELEMENTAL_NS    = "Elementaire / Rapidite de la nature",
TA_BUILD_ENH_RESTO       = "Amelioration / Restauration",
TA_BUILD_AFFLICTION      = "Affliction / Demonologie",
TA_BUILD_SOUL_LINK       = "Lien spirituel",
TA_BUILD_DS_RUIN         = "Sacrifice demoniaque / Ruine",
TA_BUILD_SM_RUIN         = "Maitrise de l'ombre / Ruine",
PROFESSIONS_REQUIRES      = "Requiert :",
PROFESSIONS_REAGENTS      = "Composants :",
PROFESSIONS_FILTER_GRAY   = "Gris",
PROFESSIONS_FILTER_GREEN  = "Vert",
PROFESSIONS_FILTER_YELLOW = "Jaune",
PROFESSIONS_FILTER_ORANGE = "Orange",
PROFESSIONS_FILTER_ALL_REAGENTS = "Tous les composants disponibles",
PROFESSIONS_FILTER_DIFFICULTY = "Difficulte",
PROFESSIONS_TRACK_RECIPE  = "Suivre cette recette",
CRAFT_TRACKER_FULL        = "Suivi d'artisanat : %d recettes au maximum peuvent etre suivies.",
PROFESSIONS_CREATE        = "Creer",
PROFESSIONS_CREATE_ALL    = "Tout creer",
PROFESSIONS_COOLDOWN      = "Temps de recharge restant : %s",
...
MERCHANT_PAGE_COUNT       = "Page %d sur %d",
