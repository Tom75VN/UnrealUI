...
SETTINGS_AUTO_ATTACK_HINT = "Cliquez ou appuyez sur Tab pour attaquer. Placez Tir automatique (chasseur) ou Tir sur une barre d'actions pour alterner entre arc/fusil et melee selon la distance. Respecte l'arret manuel et le camouflage du voleur ou du druide.",
