...
SETTINGS_BAGS_CATEGORIES_HINT = "Regroupe le contenu du sac dans des boites de categorie nommees au lieu d'une grille unique. Les categories proviennent de la classe de l'objet, il n'y a donc rien a trier ni a etiqueter a la main. Effet immediat, sans rechargement.",
