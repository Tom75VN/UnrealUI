...
SETTINGS_QUICKBIND_HINT   = "Survolez un emplacement de barre d'action et appuyez sur une touche pour l'assigner. Echap sur un emplacement l'efface.",
...
BANK_TRANSFER_EMPTY_SLOT  = "Deplacer des objets entre les sacs de banque necessite un emplacement libre dans les sacs du personnage.",
