...
SETTINGS_QUICKBIND_HINT   = "Наведите курсор на ячейку панели команд и нажмите клавишу, чтобы назначить её. Escape над ячейкой очищает привязку.",
...
AURAS_PLAYER_DEBUFFS      = "Ослабления на рамке игрока",
AURAS_TARGET_DEBUFFS      = "Ослабления на рамке цели",
AURAS_TARGET_BUFFS        = "Усиления на рамке цели",
AURAS_PARTY_DEBUFFS       = "Ослабления на рамках группы",
AURAS_PARTY_BUFFS         = "Усиления на рамках группы",
AURAS_SHOW_TIMERS         = "Таймеры на значках эффектов",
AURAS_BELOW_FRAME         = "Эффекты игрока и цели под рамками",
AURAS_DISPEL_HEADER       = "Показывать ослабления по типу рассеивания",
AURAS_MAGIC               = "Магия",
AURAS_CURSE               = "Проклятие",
AURAS_POISON              = "Яд",
AURAS_DISEASE             = "Болезнь",
AURAS_OTHER               = "Физический / прочее",
AURAS_HINT                = "Ваши собственные эффекты отсчитываются клиентом и точны. Для любого другого существа этот клиент не сообщает длительность, поэтому такие таймеры восстанавливаются по таблице длительностей заклинаний и моменту, когда эффект был впервые замечен: эффект, уже действовавший к моменту выбора цели, выглядит только что наложенным, а эффект, которого нет в таблице, не показывает таймера вовсе. Введите /uui aura, чтобы увидеть, какой из них какой.",

-- ---------------------------------------------------------------------------
-- Pet bar
-- ---------------------------------------------------------------------------
PETBAR_PAGE               = "Панель питомца",
PETBAR_BUTTONS_PER_ROW    = "Кнопок в ряду",
PETBAR_BUTTON_SIZE        = "Размер кнопок",
PETBAR_BUTTON_SPACING     = "Отступ между кнопками",
PETBAR_AUTOCAST           = "Выделять способности с автоприменением",
PETBAR_HINT               = "Отображается только при активном питомце, у которого есть собственная панель команд.",
...
BANK_TRANSFER_EMPTY_SLOT  = "Для переноса предметов между банковскими сумками нужна одна свободная ячейка в сумках персонажа.",
