...
SETTINGS_AUTO_ATTACK_HINT = "Щелчок мыши или Tab начинает атаку. Поместите «Автоматическую стрельбу» (охотник) или «Выстрел» на панель команд для переключения лука/ружья и ближнего боя по расстоянию. Учитывает ручную остановку и незаметность разбойника или друида.",
