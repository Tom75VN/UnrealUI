...
SETTINGS_AUTO_ATTACK_HINT = "Click or Tab to attack. Put Auto Shot (hunters) or Shoot on an action bar to switch between bow/gun and melee with distance. Stops when you stop attacking. Never starts during Rogue Stealth or Druid Prowl.",
