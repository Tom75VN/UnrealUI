...
CLASSIC_MODULE_QUEST_LOG     = "Quest Log interface",
CLASSIC_MODULE_BAGS          = "Bags and bank",
CLASSIC_MODULE_LOOT          = "Loot window",
...
SWING_BAR_WIDTH           = "Bar width",
SWING_BAR_HEIGHT          = "Bar height",
SWING_BAR_MAIN            = "MH",
SWING_BAR_OFF             = "OH",
SWING_BAR_RANGED          = "R",
...
SETTINGS_BAGS_CATEGORIES_HINT = "Groups the bag and bank contents into labelled category boxes instead of one flat grid. Uses each item's stored data, including separate material groups such as cloth, herbs, meat and ore. Takes effect straight away; no reload needed.",
...
ITEM_CATEGORY_LEATHER     = "Leather",
ITEM_CATEGORY_CLOTH       = "Cloth",
ITEM_CATEGORY_HERB        = "Herbs",
ITEM_CATEGORY_ORE         = "Ore & Stone",
ITEM_CATEGORY_GEM         = "Gems",
ITEM_CATEGORY_ENCHANTING  = "Enchanting Materials",
ITEM_CATEGORY_ENGINEERING = "Engineering Parts",
ITEM_CATEGORY_MEAT        = "Meat",
...
LOOT_TITLE                = "Items",
LOOT_QUALITY_0            = "Poor",
LOOT_QUALITY_1            = "Common",
LOOT_QUALITY_2            = "Uncommon",
LOOT_QUALITY_3            = "Rare",
LOOT_QUALITY_4            = "Epic",
LOOT_QUALITY_5            = "Legendary",
LOOT_QUALITY_6            = "Artifact",
BAGS_SLOT_COUNT           = "%d/%d",
BAGS_CATEGORY_EMPTY       = "Empty",
BAGS_SORT                 = "Sort Bags",
...
BAGS_INVENTORY_FULL       = "No compatible empty bag slot is available.",
...
BAGS_BANK_VIEW            = "View Saved Bank",
BAGS_BANK_VIEW_HINT       = "Shows your bank as it was at your last banker visit. Read-only.",
...
BANK_FULL                 = "No compatible empty bank slot is available.",
BANK_TITLE                = "Bank",
BANK_SORT                 = "Sort Bank",
...
BANK_VIEW_TITLE           = "Saved Bank",
BANK_VIEW_READONLY        = "Read-only",
BANK_VIEW_EMPTY           = "No bank recorded yet. Visit a banker a first time to record it.",
...
TA_TITLE                 = "Build Advisor",
TA_CONTEXT_LEVELING      = "Leveling",
TA_CONTEXT_PVP           = "PvP",
TA_CONTEXT_RAID          = "Raid",
TA_ROLE_DPS              = "Damage",
TA_ROLE_TANK             = "Tank",
TA_ROLE_HEALER           = "Healer",
TA_ROLE_HYBRID           = "Hybrid",
TA_LEGEND                = "|cffffd119Gold|r: choose now / |cffffffffWhite|r: later / |cffff3838Red|r: outside build",
TA_STATUS_NEXT           = "Next: %s (%d/%d)",
TA_STATUS_COMPLETE       = "This build is complete.",
TA_STATUS_EARN_POINT     = "Level %d: %d build points remain. Earn a talent point.",
TA_STATUS_RESPEC         = "No recommended talent is currently learnable.",
TA_STATUS_OUTSIDE        = "%d point(s) are outside this build; a respec may be needed.",
TA_STATUS_UNAVAILABLE    = "This build does not match the client's talent data.",
TA_BUILD_ARMS            = "Two-Hand Arms",
TA_BUILD_FURY            = "Dual-Wield Fury",
TA_BUILD_PROTECTION      = "Deep Protection",
TA_BUILD_FERAL           = "Feral",
TA_BUILD_HOTW_NS         = "Heart of the Wild / Nature's Swiftness",
TA_BUILD_BALANCE_NS      = "Balance / Nature's Swiftness",
TA_BUILD_MOONGLOW        = "Moonglow",
TA_BUILD_RESTORATION     = "Deep Restoration",
TA_BUILD_BEAST_MASTERY   = "Beast Mastery",
TA_BUILD_MARKSMAN        = "Marksmanship",
TA_BUILD_MARKSMAN_SURVIVAL = "Marksmanship / Survival",
TA_BUILD_FROST           = "Frost",
TA_BUILD_POM_FIRE        = "Presence of Mind / Fire",
TA_BUILD_AP_FROST        = "Arcane Power / Frost",
TA_BUILD_WINTERS_CHILL   = "Winter's Chill",
TA_BUILD_FIRE            = "Fire / Combustion",
TA_BUILD_RETRIBUTION     = "Retribution",
TA_BUILD_HOLY_PVP        = "Holy PvP",
TA_BUILD_HOLY            = "Holy",
TA_BUILD_HOLY_RETRIBUTION = "Holy / Retribution",
TA_BUILD_SHADOW_LEVELING = "Shadow Leveling",
TA_BUILD_SHADOW          = "Shadow",
TA_BUILD_DISCIPLINE      = "Deep Discipline",
TA_BUILD_COMBAT_SWORDS   = "Combat Swords",
TA_BUILD_HEMORRHAGE      = "Cold Blood / Preparation / Hemorrhage",
TA_BUILD_COMBAT_DAGGERS  = "Combat Daggers",
TA_BUILD_ENHANCEMENT     = "Enhancement",
TA_BUILD_ELEMENTAL_NS    = "Elemental / Nature's Swiftness",
TA_BUILD_ENH_RESTO       = "Enhancement / Restoration",
TA_BUILD_AFFLICTION      = "Affliction / Demonology",
TA_BUILD_SOUL_LINK       = "Soul Link",
TA_BUILD_DS_RUIN         = "Demonic Sacrifice / Ruin",
TA_BUILD_SM_RUIN         = "Shadow Mastery / Ruin",
PROFESSIONS_REQUIRES      = "Requires:",
PROFESSIONS_REAGENTS      = "Reagents:",
PROFESSIONS_FILTER_GRAY   = "Gray",
PROFESSIONS_FILTER_GREEN  = "Green",
PROFESSIONS_FILTER_YELLOW = "Yellow",
PROFESSIONS_FILTER_ORANGE = "Orange",
PROFESSIONS_FILTER_ALL_REAGENTS = "All reagents available",
PROFESSIONS_FILTER_DIFFICULTY = "Difficulty",
...
MERCHANT_PAGE_COUNT       = "Page %d of %d",
