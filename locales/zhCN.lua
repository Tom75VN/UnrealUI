...
SETTINGS_QUICKBIND_HINT   = "将鼠标悬停在动作条按钮上并按下按键即可绑定。在按钮上按 Esc 可清除绑定。",
...
-- ---------------------------------------------------------------------------
PETBAR_PAGE               = "宠物动作条",
PETBAR_BUTTONS_PER_ROW    = "每行按钮数",
PETBAR_BUTTON_SIZE        = "按钮大小",
PETBAR_BUTTON_SPACING     = "按钮间距",
PETBAR_AUTOCAST           = "高亮显示自动施放的技能",
PETBAR_HINT               = "仅当你拥有带有独立动作条的活动宠物时才会显示。",
...
BANK_TRANSFER_EMPTY_SLOT  = "在银行背包之间移动物品需要角色背包中有一个空位。",
